...
Hopefully by the end you will care a little bit more
```
...
An API is a set of functions or procedures.

Features or data of an app or opperating system.
...
It's two of the holy trinity that makes up the frontend.

HTML and CSS

HTML is the structure, like the bones of a site

CSS is like the muscles, skin and makeup
